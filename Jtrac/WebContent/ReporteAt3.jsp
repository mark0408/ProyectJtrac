...
<div id="conten2">
	<div>
        ...
        <%--2. usar la etiqueta select pero de struts-jquery--%>
            ...
            <sj:select name="states" id="estado" class="browser-default custom-select custom-select-lg mb-3"
    ...
    <div id="ocultar">
        ...
        <%--2. usar la etiqueta select pero de struts-jquery   class="custom-select"    --%>
     <div class="estado">
...
function (){
	...
	var table=$('#idTableProyecto').DataTable();
	  $.ajax({
	        url:"listarReporte3",
	        data :"jtrac="+$("#estado").val()+"&estado="+$("#estado2").val(), //mandar parametro
	        dataType : "json",
	        success : function(result) {
	        	...
	        	table= $('#idTableProyecto').dataTable({
	        	     ...
	        	     buttons: [
	        		    ...
	        		    data:result.lstReporte3,
	        		   
	        		    
	        		   columns: [
	        	            { data: "jtrac",title:"Jtrac" },
	        	            { data: "cantidad",title:"Cantidad" },
	        	            { data: "fecha",title:"Dia y Hora" }
